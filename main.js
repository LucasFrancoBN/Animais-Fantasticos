...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAnimacaoScroll)\n/* harmony export */ });\nfunction initAnimacaoScroll() {\n  var articles = document.querySelectorAll(\"[data-anime='scroll']\");\n  function animarScroll() {\n    articles.forEach(function (article) {\n      var topoArticle = article.getBoundingClientRect().top;\n      var alturaWindow = window.innerHeight * 0.5;\n      var verificadorAltura = topoArticle < alturaWindow;\n      if (verificadorAltura) article.classList.add(\"animacao-scroll\");else if (article.classList.contains(\"animacao-scroll\")) {\n        article.classList.remove(\"animacao-scroll\");\n      }\n    });\n  }\n  animarScroll();\n  window.addEventListener(\"scroll\", animarScroll);\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/scroll-animacao.js?");
